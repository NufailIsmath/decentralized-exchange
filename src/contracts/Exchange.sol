...
contract Exchange {
    ...
    address constant ETHER = address(0); //allows ether to store in tokens mapping with blank address
    ...
    //If ether sent directly to this smart contract
